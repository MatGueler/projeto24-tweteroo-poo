...
class User {
    ...
    signUp() {
        if (!this.picture.value || !this.username.value) {
            alert("Digite username de usu\xe1rio e insira uma foto");
            return;
        }
        this._username = this.username.value;
        this._picture = this.picture.value;
...
class Tweets {
    ...
    renderTweet() {
        this.tweetsHtml = "";
        for (const tweet of this.tweets)this.tweetsHtml += `
        <div class="tweet">
          <div class="avatar">
    ...
    postTweet() {
        if (!this.tweetInput.value) {
            alert("Campo de tweet n\xe3o pode ser nulo");
            return;
        }
...
},{}]},["2mNKm","6rimH"], "6rimH", "parcelRequire72cf")
